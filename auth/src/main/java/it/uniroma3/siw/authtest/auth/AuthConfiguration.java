package it.uniroma3.siw.authtest.auth;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeRequests()
                    ...
                    .antMatchers(HttpMethod.GET, "/", "/index","/home","/welcome","/fotografiGuest").permitAll()
                    

                    // only admin can access the admin page
                    .antMatchers(HttpMethod.GET, "/admin").hasAnyAuthority("ADMIN")
                    .antMatchers(HttpMethod.GET, "/fotografoForm").hasAnyAuthority("ADMIN")
                    .antMatchers(HttpMethod.POST, "/fotografo").hasAnyAuthority("ADMIN")
